...
Data_Framework = {"初始电压": 4.179592, "电池内阻": 110.0, "红线线长": 0, "黑线线长": 0.0, "蓝线线长": 0,
                  "线号线阻": 289.0, "mos内阻": 60.0, "发热丝阻值": 1.197, "恒压输出": 3.6, "目标功率": 0,
                  "每口工作时间(s)": 2.0, "每组口数": 1,
                  "总容量": 317}
# :"发热丝阻值": 1.163
...
filename = r'C:\Users\WX\Desktop\Python\600V2_V1.1.xls'
